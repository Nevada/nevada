...
/**
 * Edit view for Office records.
 */
public class OfficeEditView extends Composite implements
    RecordEditView<OfficeRecord> {
  interface Binder extends UiBinder<HTMLPanel, OfficeEditView> {
  }

  interface DataBinder extends EditorSupport<OfficeRecord, OfficeEditView> {
  }
  ...
  public OfficeEditView asWidget() {
    return this;
  }
  ...
  public void setValue(OfficeRecord value) {
    this.record = value;
